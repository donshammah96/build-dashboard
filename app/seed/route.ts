...
async function seedProfessionals() {
  ...
  await sql`
    CREATE TABLE IF NOT EXISTS professionals (
      ...
      completed_projects_value_currency_symbol_position_position VARCHAR(3) NOT NULL DEFAULT 'left',
...
async function seedProfessionalServices() {
  ...
  await sql`
    CREATE TABLE IF NOT EXISTS professional_services (
      ...
      fixed_price_range_currency_symbol_position_position VARCHAR(3) NOT NULL DEFAULT 'left',
  ...
  const insertedProfessionalServices = await Promise.all(
    professional_services.map(async (professional_service) => {
      return sql`
        INSERT INTO professional_services (id, professional_id, service_name, service_description, hourly_rate, fixed_price_range_min, fixed_price_range_max, fixed_price_range_currency, fixed_price_range_currency_symbol, fixed_price_range_currency_symbol_position, fixed_price_range_currency_symbol_position_position, is_available, is_active, created_at, updated_at)
        VALUES (${professional_service.id}, ${professional_service.professional_id}, ${professional_service.service_name}, ${professional_service.service_description}, ${professional_service.hourly_rate}, ${professional_service.fixed_price_range_min}, ${professional_service.fixed_price_range_max}, ${professional_service.fixed_price_range_currency}, ${professional_service.fixed_price_range_currency_symbol}, ${professional_service.fixed_price_range_currency_symbol_position}, ${professional_service.fixed_price_range_currency_symbol_position_position}, ${professional_service.is_available}, ${professional_service.is_active}, ${professional_service.created_at}, ${professional_service.updated_at})
        ON CONFLICT (id) DO NOTHING;
      `;
    }),
  );
...
async function seedClients() {
  ...
  await sql`
    CREATE TABLE IF NOT EXISTS clients (
      ...
      project_budget_preference_currency_symbol_position_position VARCHAR(3) DEFAULT 'left',
